...
{if !$invalidTicketId}
    ...
    {foreach from=$descreplies key=num item=reply}
        ...
        <div class="ticket-reply-coodiv ticket-reply markdown-content{if $reply.admin} staff{/if}">
            <div class="user">
                <img src="{$WEB_ROOT}/templates/{$template}/img/gravatar.jpg" class="gravatar" alt="User-Profile-Image">
