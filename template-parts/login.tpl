...
<div class="dropdown drp-user {if !$loggedin}not-login{/if}">
		...
		<a data-toggle="tooltip" data-placement="top" title="{$LANG.navtickets}" href="supporttickets.php"  href="#" class="col-md-4 acount-top-header-acc">
		<i class="feather icon-inbox"></i>
		</a>
		<a data-toggle="tooltip" data-placement="top" title="{$LANG.navinvoices}" href="clientarea.php?action=invoices" href="#" class="col-md-4 acount-top-header-acc np-bord-right">
		<i class="feather icon-clipboard"></i>
		</a>
		<a data-toggle="tooltip" data-placement="top" title="{$LANG.logouttitle}" href="logout.php" class="col-md-4 acount-top-header-acc">
